...
import AddToCartComponent from "../Mobile/AddToCartComponent";
...
export default class ProductCard extends Component{
    ...
    render(){
        ...
        return(
            <div id={"product_id_"+prodId} data-index="0" className="slick-slide slick-active slick-current" tabindex="-1" aria-hidden="false" >
							<div>
								<div className="display--inline-block vertical-align--top" tabindex="-1" >
									<a className="product__wrapper" data-test-id="plp-product" href={prodUrl}>
										<div className="plp-product">
											...
											<div className="plp-product__quantity" title="1 l" data-test-id="product-unit"><span>{quantity}</span>
											</div>
											<div className="relative">
												<div className="plp-product__price">
													<div className="plp-product__price--container">
														<div className="display--inline-block@mobile"><span className="plp-product__price--new" data-test-id="plp-product-new-price">{"₹"}{price-moneyDiscount}</span>
														</div>
