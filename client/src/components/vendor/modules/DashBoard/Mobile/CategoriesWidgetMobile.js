...
function CarouselNextArrow(props) {
    ...
    return (
        ...
        <button className="slider__arrow slider__arrow--next category-slider__arrow-next d-none">
  ...
  function CarouselPrevArrow(props) {
    const { onClick } = props;
    return (
        <button className="slider__arrow slider__arrow--prev category-slider__arrow-previous d-none">
...
export default class CategoriesWidgetMobile extends Component{
