...
mongoose.connect("mongodb://localhost:27017/grocery_now_db",{ useNewUrlParser: true })
...
cloudinary.config({
    cloud_name: "grocery-store",
    api_key: "481468917554535",
    api_secret: "DIZTwS0MAWMRM5LYj9kSygZz0c4"
})
...
app.get('/api/category/subcategories',(req,res)=>{
    SubCategory.find({},(err,categories)=>{
        if(err) return res.status(400).send(err);
        res.status(200).send(categories)
    })
})
...
app.post('/api/category/subsubcategory',auth,admin,(req,res)=>{
...
app.post('/api/users/otp_login', (req, res) => {
...
app.post('/api/users/login',(req,res)=>{
    User.findOne({'email':req.body.email},(err,user)=>{
        ...
        console.log("user detected", user, "password",req.body.password);
